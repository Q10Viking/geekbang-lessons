...
public class BeanInstantiationCycleDemo10 {
...
/**
 ...
 销毁阶段 preDestroy: V9.0 => V10.0
 销毁阶段 destroy: V10.0 => V11.0
 销毁阶段 doDestroy: V11.0 => V12.0
 UserHolder{user=SuperUser{address='杭州'} User{id=1, name='黄壮壮', beanName='superUser'}, number=100, version='V12.0', beanName='userHolder'}
 */