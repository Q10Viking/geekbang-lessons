...
public class BeanInstantiationCycleDemo7 {
...
/**
 ...
 UserHolder{user=SuperUser{address='杭州'} User{id=1, name='黄壮壮', beanName='superUser'}, number=100, version='V7.0', beanName='userHolder'}
 */